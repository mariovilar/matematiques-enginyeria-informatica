...
layout (location = 3) in vec2 vTexCoords; // Afegir si usem textures en un futur
...
out vec2 TexCoords; // Fragment amb textures
...
void main()
{
    ...
    // 4. Passem les coordenades de textura (si s'usen)
    TexCoords = vTexCoords;

    // 5. Calcula la posició final 
